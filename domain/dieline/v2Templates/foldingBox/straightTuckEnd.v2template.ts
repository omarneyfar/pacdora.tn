...
export type V2StraightTuckEndParameters = {
  L?: number;
  W?: number;
  H?: number;
  GFW?: number;
...
export function generateV2StraightTuckEndAssembly(values: V2StraightTuckEndParameters = {}): V2TemplateAssembly {
  ...
  return assembleV2Template({
    id: "straight-tuck-end-v2-template",
    label: "V2 Straight Tuck End Folding Carton Box",
...
export function generateV2StraightTuckEndDielineGraph(values: ParameterValueMap = {}): DielineGraph {
  return toDielineGraph(generateV2StraightTuckEndAssembly({
