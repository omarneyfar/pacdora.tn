...
export const CEFBOX_FOLDING_BOX_DEFINITIONS: FoldingBoxVariantDefinition[] = [
  {
    ...
    description: "Tuck ends on both top and bottom, opening from opposite panels.",
    length: 120.65,
    width: 60.72,
    height: 161.13,
    top: "tuck-front",
  ...
  },
  {
    ...
    description: "Tuck ends on top and bottom opening from the same side.",
    length: 120.65,
    width: 60.72,
    height: 161.13,
    top: "tuck-front",
  ...
  },
  {
    ...
    description: "Tuck top with pre-glued auto-lock bottom for quick assembly.",
    length: 120.65,
    width: 60.72,
    height: 161.13,
    top: "tuck-front",
  ...
  },
  {
    ...
    description: "Tuck top with manually folded snap-lock bottom.",
    length: 120.65,
    width: 60.72,
    height: 161.13,
    top: "tuck-front",
  ...
  },
  {
    ...
    description: "Folding carton with integrated folded handle structure.",
    length: 120.65,
    width: 60.72,
    height: 161.13,
    top: "handle",
    bottom: "snap-lock",
    parameters: ["HL", "HW", "HT", "SR", "TD1", "TD2", "PR", "FW1", "FW2", "GFW", "OD", "TFW", "DFW"],
    features: ["handle"],
  },
  {
    ...
    description: "Retail folding carton with circular hang hole panel.",
    length: 120.65,
    width: 60.72,
    height: 161.13,
    top: "hang-hole",
  ...
  {
    id: "with-hang-tab",
    label: "Folding Carton Box with a Hang Tab",
    fileName: "with-hang-tab",
    description: "Retail peg-hook folding carton with hang tab.",
    length: 120.65,
    width: 60.72,
    height: 161.13,
    top: "hang-tab",
    bottom: "tuck-front",
    parameters: ["SL", "SW", "FR", "SAL", "TFW1", "TW", "OD1", "TFW2", "TFR", "DFW", "GFW", "TFW"],
    features: ["hang-tab"],
  },
  {
    ...
    description: "Folding carton with locking tab closure on both top and bottom.",
    length: 120.65,
    width: 60.72,
    height: 161.13,
    top: "tab-closure",
    bottom: "tuck-front",
    parameters: ["TL", "TR", "TD1", "TD2", "PR", "TFW", "TFR", "DFW", "GFW"],
  },
  {
    id: "with-built-in-inserts",
    label: "Folding Box with Built-in Inserts",
    fileName: "with-built-in-inserts",
    description: "Folding carton with integrated insert flaps for product protection.",
    length: 120.65,
    width: 60.72,
    height: 161.13,
    top: "tuck-front",
  ...
  },
  {
    ...
    label: "Folding Carton with Integrated Partitions",
    fileName: "carton-with-integrated-partitions",
    description: "Folding carton with built-in partitions for multiple compartments.",
    length: 120.65,
    width: 60.72,
    height: 161.13,
    top: "tuck-front",
    bottom: "auto-lock",
    parameters: ["PD1", "PD2", "TFW1", "GFW", "TFR", "DFW", "TFW"],
    features: ["partitions"],
  },
  {
    id: "carton-with-centered-divider",
    label: "Folding Carton with Built-in Centered Divider",
    fileName: "carton-with-centered-divider",
    description: "Folding carton with centered internal divider.",
    length: 120.65,
    width: 60.72,
    height: 161.13,
    top: "centered-tuck",
    bottom: "auto-lock",
    parameters: ["OD1", "OD2", "TFW1", "GFW", "TFR", "DFW", "DL", "TFW"],
    features: ["divider"],
  },
  {
    id: "carton-with-three-windows",
    label: "Snap Lock Bottom Folding Carton with Divider and Windows",
    fileName: "carton-with-three-windows",
    description: "Snap-lock bottom carton with internal divider and multiple windows.",
    length: 120.65,
    width: 60.72,
    height: 161.13,
    top: "tab-closure",
  ...
  },
  {
    ...
    label: "Snap Lock Bottom Folding Carton with Tab Closure",
    fileName: "snap-lock-bottom-carton-with-tab-closure",
    description: "Snap-lock bottom carton with tab closure top.",
    length: 120.65,
    width: 60.72,
    height: 161.13,
    top: "tab-closure",
  ...
  },
  {
    ...
    label: "Auto-lock Bottom Folding Carton with Tab Closure",
    fileName: "auto-lock-bottom-carton-with-tab-closure",
    description: "Auto-lock bottom carton with tab closure top.",
    length: 120.65,
    width: 60.72,
    height: 161.13,
    top: "tab-closure",
  ...
  },
  {
    ...
    label: "Snap-lock Bottom Folding Carton with Divider",
    fileName: "snap-lock-bottom-carton-with-divider",
    description: "Snap-lock bottom carton with integrated centered divider.",
    length: 120.65,
    width: 60.72,
    height: 161.13,
    top: "tab-closure",
  ...
  },
  {
    ...
    label: "Snap-lock Carton with Arc Handle",
    fileName: "snap-lock-carton-with-arc-handler",
    description: "Snap-lock carton with arched handle feature.",
    length: 120.65,
    width: 60.72,
    height: 161.13,
    top: "handle",
    bottom: "snap-lock",
    parameters: ["HT", "HR", "SR", "TFW", "TFR", "GFW", "DFW"],
    features: ["handle"],
  },
  {
    id: "centered-tuck-end-carton",
    label: "Centered Tuck End Folding Carton",
    fileName: "centered-tuck-end-carton",
    description: "Tuck end carton with centered tuck closure geometry.",
    length: 120.65,
    width: 60.72,
    height: 161.13,
    top: "centered-tuck",
    bottom: "tuck-front",
    parameters: ["D1", "TFW1", "D2", "TFR", "TFW2", "GFW", "TFW", "DFW"],
  },
  {
    id: "gusset-roof-carton-with-tear-strip",
    label: "Gusset Roof Carton with Tear Strip",
    fileName: "gusset-roof-carton-with-tear-strip",
    description: "Gusset roof folding carton with tear strip opening.",
    length: 120.65,
    width: 60.72,
    height: 161.13,
    top: "gusset",
    bottom: "auto-lock",
    parameters: ["BFW", "TFW", "OD", "GFW", "DFW"],
    features: ["tear-strip"],
  },
  {
    id: "snap-lock-bottom-carton-with-mount",
    label: "Snap-lock Bottom Carton with Built-in Mount",
    fileName: "snap-lock-bottom-carton-with-mount",
    description: "Snap-lock bottom carton with internal product mount.",
    length: 120.65,
    width: 60.72,
    height: 161.13,
    top: "tab-closure",
    bottom: "snap-lock",
    parameters: ["D1", "D2", "SR", "TL", "TR", "TD1", "TD2", "PR", "TFW", "TFR", "GFW", "DFW"],
    features: ["mount"],
  },
  {
    id: "tuck-end-folding-carton",
    label: "Tuck End Folding Carton",
    fileName: "tuck-end-folding-carton",
    description: "General tuck-end folding carton structure.",
    length: 120.65,
    width: 60.72,
    height: 161.13,
    top: "tuck-front",
    bottom: "tuck-front",
    parameters: ["SL", "TFW", "GFW", "FW", "DFW"],
  },
  {
    id: "reversible-lid-skillet-carton",
    label: "Skillet Box with Reversible Lid",
    fileName: "reversible-lid-skillet-carton",
    description: "Skillet carton with reversible top lid structure.",
    length: 120.65,
    width: 60.72,
    height: 161.13,
    top: "reversible",
    bottom: "crash-bottom",
    parameters: ["DFW", "OD1", "OD2", "OD3", "OD4", "SL1", "SL2", "SW2", "SR2", "EA1", "EA2", "GFW", "TFW"],
    features: ["skillet"],
  },
  {
    id: "reversible-lid-folding-carton",
    label: "Crash Bottom Folding Carton with Reversible Top Cover",
    ...
    top: "reversible",
    bottom: "crash-bottom",
    parameters: ["DFW", "OD1", "OD2", "OD3", "OD4", "SL1", "SL2", "SW2", "SR", "EA1", "EA2", "GFW", "TFW"],
  },
  {
    id: "gusset-cover-crash-bottom-carton",
    label: "Gusset Cover Crash Bottom Carton",
    fileName: "gusset-cover-crash-bottom-carton",
    description: "Folding carton with gusset cover and crash bottom.",
    length: 120.65,
    width: 60.72,
    height: 161.13,
    top: "gusset",
    bottom: "crash-bottom",
    parameters: ["TFW", "FW", "GFW", "FR", "DFW"],
  },
  {
    ...
    description: "Auto-lock bottom carton with full-flap bottom panel.",
    length: 120.65,
    width: 60.72,
    height: 161.13,
    top: "tuck-front",
  ...
  },
  {
    ...
    label: "Folding Box with Circular Hang Hole and Window",
    fileName: "with-circular-hang-hole-and-window",
    description: "Retail folding carton with circular hang hole and display window.",
    length: 120.65,
    width: 60.72,
    height: 161.13,
    top: "hang-hole",
  ...
  },
  {
    ...
    description: "Folding carton with integrated handle and display window.",
    length: 120.65,
    width: 60.72,
    height: 161.13,
    top: "handle",
    bottom: "snap-lock",
    parameters: ["HL", "HW", "HT", "SR", "TD1", "TD2", "PR", "FW1", "FW2", "GFW", "OD", "WL", "WH", "WR", "TFW", "DFW"],
  ...
  },
  {
    ...
    description: "Two-piece or separated skillet-style folding carton.",
    length: 120.65,
    width: 60.72,
    height: 161.13,
    top: "gusset",
    bottom: "snap-lock",
    parameters: ["FL", "BL", "TFW", "GD", "OD", "SR", "SL", "SW1", "SW2", "GFW", "DFW"],
    features: ["skillet"],
  },
  {
    ...
    description: "Crash/auto-lock bottom carton with tearable strip seal.",
    length: 120.65,
    width: 60.72,
    height: 161.13,
    top: "tuck-front",
    bottom: "crash-bottom",
    parameters: ["GFW", "DFW", "OD1", "OD2", "EXD", "R1", "R2", "R3", "GFA", "TFW"],
    features: ["tear-strip"],
  },
  {
    ...
    description: "Snap-lock bottom carton with tearable strip seal.",
    length: 120.65,
    width: 60.72,
    height: 161.13,
    top: "tuck-front",
